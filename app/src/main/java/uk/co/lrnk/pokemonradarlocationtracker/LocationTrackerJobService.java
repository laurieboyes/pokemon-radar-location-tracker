...
//        String url = "https://mon-radar.herokuapp.com/api/updateLocation/";
        ...
        try {
            JSONObject body = new JSONObject("{\"uuid\":\"48abbf1a-e0dd-4a51-850d-61250ef67aeb\",\"location\":{\"lat\":\"" + location.getLatitude() + "\",\"lng\":\"" + location.getLongitude() + "\"}, \"updatedAt\":\"" + new Date().toString() + "\"}");
